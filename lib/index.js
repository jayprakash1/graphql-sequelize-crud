                ...
                before: function before(findOptions, args, context, info) {
                  _.forOwn(args, function (value, key) {
                    if (target.customConnectionArgs && target.customConnectionArgs[key]) {
                      _.assignWith(findOptions.where, target.customConnectionArgs[key].whrClause(value, findOptions), function (value, other, key) {
                        return _.isUndefined(value) ? other : { $and: [_defineProperty({}, key, value), _defineProperty({}, key, other)] };
                      });
                    }
                  });
                  return findOptions;
