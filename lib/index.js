                ...
                before: function before(findOptions, args, context, info) {
                  _.forOwn(args, function (value, key) {
                    if (target.customConnectionArgs && target.customConnectionArgs[key]) {
                      var cond = target.customConnectionArgs[key].whrClause(value, findOptions);
                      ...
                      if (findOptions.where[Object.keys(cond)[0]] && findOptions.where[Object.keys(cond)[0]] != value) {
                        findOptions.where["$and"] = findOptions.where["$and"] ? [].concat(_toConsumableArray(findOptions.where["$and"]), [_defineProperty({}, Object.keys(cond)[0], findOptions.where[Object.keys(cond)[0]]), cond]) : [_defineProperty({}, Object.keys(cond)[0], findOptions.where[Object.keys(cond)[0]]), cond];
                      } else {
